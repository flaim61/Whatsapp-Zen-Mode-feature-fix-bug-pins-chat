...
// Render
const $59cfff4c2ddf70fb57fe7c3506c22bc5$var$titleEl = document.getElementById('titleOnboarding');
const $59cfff4c2ddf70fb57fe7c3506c22bc5$var$agreeEl = document.getElementById('agreeOnboarding');
function $59cfff4c2ddf70fb57fe7c3506c22bc5$var$constructLocales() {
    $59cfff4c2ddf70fb57fe7c3506c22bc5$var$titleEl.textContent = (/*@__PURE__*/$parcel$interopDefault($7IzVc)).i18n.getMessage('ZM_onboarding_page_title');
    $59cfff4c2ddf70fb57fe7c3506c22bc5$var$agreeEl.textContent = (/*@__PURE__*/$parcel$interopDefault($7IzVc)).i18n.getMessage('ZM_onboarding_page_agree');
}
$59cfff4c2ddf70fb57fe7c3506c22bc5$var$constructLocales();
// Set listeners
$59cfff4c2ddf70fb57fe7c3506c22bc5$var$agreeEl.addEventListener('click', function() {
    window.close();
});
